    ...
    chapters: [
      {
        ...
        topics: [
          ...
          'n-factor & Equivalent Weight in Redox',
      ...
      },
      {
        ...
        cardCount: 58,
        topics: [
          'Ionic Bond, Lattice Energy & Born-Haber',
          'Lewis Structures, Octet & Formal Charge',
          'Bond Parameters (Length, Energy, Order)',
          'Dipole Moment & Molecular Polarity',
          'Fajans\' Rule & Covalent Character in Ionic Bonds',
          'VSEPR & Molecular Geometry',
          'Valence Bond Theory & Hybridization',
          'Bent\'s Rule, Drago\'s Rule & Back-Bonding',
      ...
      },
      {
        ...
        topics: [
          ...
          'Reaction Quotient (Q) & Direction Prediction',
          'Le Chatelier\'s Principle',
          'Degree of Dissociation (α) & Vapour Density',
          'ICE Tables & Equilibrium Calculations',
          'Thermodynamic Connection & Common Confusions',
        ],
      },
      {
        id: 'ch11_ionic_eq',
        name: 'Ionic Equilibrium',
        displayName: 'Ionic Equilibrium',
        category: 'Physical Chemistry',
        topicCount: 9,
        cardCount: 63,
        topics: [
          'Acid-Base Theories & Conjugate Pairs',
    ...
    chapters: [
      {
        id: 'ch11_hydrocarbon',
        name: 'Hydrocarbons',
        displayName: 'Hydrocarbons (Class 11)',
    ...
    chapters: [
      {
        ...
        displayName: 'Periodic Table & Periodicity',
        ...
        topics: [
          ...
          'Electronegativity',
          'Diagonal Relationship & Anomalies',
          'Oxides, Hydrides — Acid/Base Character',
          'Inert Pair Effect & Special Trends',
        ],
      },
      {
        id: 'fc_d_f_block',
