// GET /api/v2/chapters — list chapters from the taxonomy source of truth
// (packages/data/taxonomy/taxonomyData_from_csv.ts), enriched with per-
// chapter star-question counts aggregated from questions_v2.
//
// No auth — this is the chapter list both student and admin UIs load on
// startup. Both apps re-export GET from this module so the handler lives
// in one place.
