...
// Renders a `circuit_bench` block: an optional predict-first gate, then the E3
// bench (netlist + nodal solve + the topological REDRAW), with title/caption.
//
...
// circuit-bench/archetypes.ts for the construction library and
// PHYSICS_SIMULATION_PROGRAM.md §7 for the pedagogy.
...
const CircuitBench = dynamic(() => import('./circuit-bench/CircuitBench'), {
  ssr: false,
  loading: () => (
    <div
...
export default function CircuitBenchRenderer({ block }: { block: CircuitBenchBlock }) {
