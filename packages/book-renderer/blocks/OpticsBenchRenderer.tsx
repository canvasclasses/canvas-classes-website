...
// Renders an `optics_bench` block: an optional predict-first gate, then the E4
// bench (real ray tracer / Instrument Assembler / wave optics, chosen by
// `mode`), with title/caption.
//
...
// optics-bench/archetypes.ts for the construction library and
// PHYSICS_SIMULATION_PROGRAM.md §6 for the pedagogy.
...
const OpticsBench = dynamic(() => import('./optics-bench/OpticsBench'), {
  ssr: false,
  loading: () => (
    <div
...
export default function OpticsBenchRenderer({ block }: { block: OpticsBenchBlock }) {
