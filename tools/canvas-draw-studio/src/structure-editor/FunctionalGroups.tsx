// Quick-insert buttons for the functional groups that come up most in JEE/NEET
// organic chemistry. Each hands Ketcher's OWN functional-group template (the
// authoritative molfile, carrying the collapsed-abbreviation S-group + attachment
// point) to the native template tool: click a button to "arm" the group, then
// click a bond terminal/atom on the canvas and it attaches as the proper
// literature abbreviation (NO₂, not N+2 O's), balancing valences. Falls back to
// addFragment() if the template tool isn't reachable.
