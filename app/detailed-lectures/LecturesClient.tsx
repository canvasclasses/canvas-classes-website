                                            ...
                                            <div className="p-5 flex flex-col flex-grow">
                                                ...
                                                <div className="grid grid-cols-1 gap-3 mt-auto">
                                                    <Link href={`/detailed-lectures/${chapter.slug}`} className="w-full">
                                                        <button className="cursor-pointer w-full py-2.5 bg-teal-600 hover:bg-teal-500 text-white rounded-xl font-semibold transition-colors flex items-center justify-center gap-2 shadow-lg shadow-teal-900/20 group-hover:shadow-teal-500/20">
                                                    ...
                                                    {chapter.notesLink && (
                                                        <a
                                                            ...
                                                            className="cursor-pointer group/btn w-full py-2.5 bg-gray-800 hover:bg-gray-750 text-gray-200 hover:text-white rounded-xl font-semibold text-sm transition-all duration-300 border border-gray-700 hover:border-teal-500/50 hover:shadow-lg hover:shadow-teal-500/10 flex items-center justify-center gap-2"
                                                        >
