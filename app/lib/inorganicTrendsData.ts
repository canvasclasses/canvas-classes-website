    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                trend: "$NH_3(107.8^\\circ) > PH_3(93.6^\\circ) > AsH_3(91.8^\\circ) > SbH_3(91.3^\\circ)$",
    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                trend: "$MF < MCl < MBr < MI$ (Covalent character increases)",
                logic: "Fajans' Rule. Larger anions ($I^-$) are more easily polarized by the cation, leading to higher covalent character."
            },
            {
                id: 35,
            ...
            },
            {
                ...
                trend: "Tl(I) > Tl(III)",
                logic: "$TlI_3$ is actually $Tl^+(I_3)^-$, not Thallium(III) iodide. Tl prefers +1 due to inert pair effect."
            },
            {
                id: 40,
