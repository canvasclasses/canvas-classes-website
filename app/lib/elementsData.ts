...
export const ELEMENTS: Element[] = [
    ...
    { atomicNumber: 39, symbol: 'Y', name: 'Yttrium', atomicMass: 88.906, category: 'Transition Metal', block: 'd', group: 3, period: 5, electronConfig: '[Kr] 4d¹ 5s²', atomicRadius: 212, ionizationEnergy: 600, electronegativity: 1.22, electronAffinity: 29.6, density: 4.47, meltingPoint: 1799, boilingPoint: 3609, row: 5, col: 3 },
    {
        atomicNumber: 40,
        symbol: 'Zr',
        name: 'Zirconium',
    ...
    { atomicNumber: 41, symbol: 'Nb', name: 'Niobium', atomicMass: 92.906, category: 'Transition Metal', block: 'd', group: 5, period: 5, electronConfig: '[Kr] 4d⁴ 5s¹', atomicRadius: 198, ionizationEnergy: 652, electronegativity: 1.60, electronAffinity: 86.1, density: 8.57, meltingPoint: 2750, boilingPoint: 5017, isException: true, exceptionType: 'Electron Configuration', exceptionExplanation: 'Nb has 4d⁴5s¹ instead of 4d³5s² for extra stability', row: 5, col: 5 },
    {
        atomicNumber: 42,
        symbol: 'Mo',
        name: 'Molybdenum',
    ...
    { atomicNumber: 43, symbol: 'Tc', name: 'Technetium', atomicMass: 98, category: 'Transition Metal', block: 'd', group: 7, period: 5, electronConfig: '[Kr] 4d⁵ 5s²', atomicRadius: 183, ionizationEnergy: 702, electronegativity: 1.90, electronAffinity: 53, density: 11.50, meltingPoint: 2430, boilingPoint: 4538, row: 5, col: 7 },
    { atomicNumber: 44, symbol: 'Ru', name: 'Ruthenium', atomicMass: 101.07, category: 'Transition Metal', block: 'd', group: 8, period: 5, electronConfig: '[Kr] 4d⁷ 5s¹', atomicRadius: 178, ionizationEnergy: 710, electronegativity: 2.20, electronAffinity: 101.3, density: 12.37, meltingPoint: 2607, boilingPoint: 4423, isException: true, exceptionType: 'Electron Configuration', exceptionExplanation: 'Expected [Kr]4d⁶5s². Actual [Kr]4d⁷5s¹ due to very small 4d-5s energy gap and e⁻-e⁻ repulsion in 5s.', row: 5, col: 8 },
    {
        atomicNumber: 45,
        symbol: 'Rh',
        name: 'Rhodium',
    ...
    { atomicNumber: 73, symbol: 'Ta', name: 'Tantalum', atomicMass: 180.95, category: 'Transition Metal', block: 'd', group: 5, period: 6, electronConfig: '[Xe] 4f¹⁴ 5d³ 6s²', atomicRadius: 200, ionizationEnergy: 761, electronegativity: 1.50, electronAffinity: 31, density: 16.65, meltingPoint: 3290, boilingPoint: 5731, oxidationStates: [5, 3, 4], trendPosition: 'Max oxidation state +5 (group 5) — highly corrosion-resistant metal used in capacitors', row: 6, col: 5 },
    { atomicNumber: 74, symbol: 'W', name: 'Tungsten', atomicMass: 183.84, category: 'Transition Metal', block: 'd', group: 6, period: 6, electronConfig: '[Xe] 4f¹⁴ 5d⁴ 6s²', atomicRadius: 193, ionizationEnergy: 770, electronegativity: 2.36, electronAffinity: 78.6, density: 19.25, meltingPoint: 3695, boilingPoint: 5828, isException: true, exceptionType: 'Physical Property', exceptionExplanation: 'W has the highest melting point (3695 K) and boiling point (5828 K) of all elements — used in light bulb filaments', oxidationStates: [6, 4, 2], trendPosition: 'Highest melting point element — used in filaments; max ox state +6', row: 6, col: 6 },
    {
        atomicNumber: 75,
        symbol: 'Re',
        name: 'Rhenium',
    ...
    { atomicNumber: 97, symbol: 'Bk', name: 'Berkelium', atomicMass: 247, category: 'Actinide', block: 'f', group: 3, period: 7, electronConfig: '[Rn] 5f⁸ 6d¹ 7s²', ionConfigs: { M3plus: '5f⁸', M4plus: '5f⁷' }, ionicRadii: { M3plus: 98, M4plus: 87 }, oxidationStates: [3, 4], stableOxidationState: 3, fSubshellInfo: 'Bk⁴⁺ achieves half-filled 5f⁷', row: 9, col: 11 },
