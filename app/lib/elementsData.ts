...
export const ELEMENTS: Element[] = [
    ...
    { atomicNumber: 17, symbol: 'Cl', name: 'Chlorine', atomicMass: 35.45, category: 'Reactive Nonmetal', block: 'p', group: 17, period: 3, electronConfig: '[Ne]3s²3p⁵', atomicRadius: 99, ionicRadius: 184, ionizationEnergy: 1256, electronegativity: 3.2, electronAffinity: -349, density: 1.66, meltingPoint: 172.0, boilingPoint: 239.0, standardReductionPotential: 1.36, gasColor: { formula: 'Cl₂', color: 'greenish yellow', hexColor: '#9ACD32' }, compoundsInfo: [{ formula: 'ClO₂', color: 'intense yellow', hexColor: '#FFD700', nature: 'acidic' }, { formula: 'Cl₂O', color: 'brown/yellow', hexColor: '#DAA520', nature: 'acidic' }, { formula: 'NH₄Cl', color: 'White', hexColor: '#FFFFFF', nature: 'acidic' }], oxides: ['Cl₂O₇'], oxideNature: 'acidic', oxideNatureDetails: 'Cl₂O₇ is strongly acidic → HClO₄ (perchloric acid)', row: 3, col: 17 },
    ...
    { atomicNumber: 19, symbol: 'K', name: 'Potassium', atomicMass: 39.10, category: 'Alkali Metal', block: 's', group: 1, period: 4, electronConfig: '[Ar]4s¹', atomicRadius: 227, ionicRadius: 138, ionizationEnergy: 419, electronegativity: 0.82, electronAffinity: -48, density: 0.86, meltingPoint: 336, boilingPoint: 1032, standardReductionPotential: -2.925, flameColor: { color: 'Lilac/violet', hexColor: '#C8A2C8' }, oxides: ['K₂O'], oxideNature: 'basic', oxideNatureDetails: 'K₂O is strongly basic', compoundsInfo: [{ formula: 'K₂CrO₄', color: 'Yellow (soln)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'K₃[Co(NO₂)₆]', color: 'Yellow (soln)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'K₄[Fe(CN)₆]', color: 'Yellow (soln)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'KMnO₄', color: 'Dark Purple', hexColor: '#800080', nature: 'neutral' }, { formula: 'K₂Cr₂O₇', color: 'Orange', hexColor: '#FFA500', nature: 'neutral' }], row: 4, col: 1 },
    { atomicNumber: 20, symbol: 'Ca', name: 'Calcium', atomicMass: 40.08, category: 'Alkaline Earth Metal', block: 's', group: 2, period: 4, electronConfig: '[Ar]4s²', atomicRadius: 197, ionicRadius: 100, ionizationEnergy: 590, electronegativity: 1.00, density: 1.55, meltingPoint: 1124, boilingPoint: 1767, standardReductionPotential: -2.84, flameColor: { color: 'Brick red', hexColor: '#CB4154' }, oxides: ['CaO'], oxideNature: 'basic', oxideNatureDetails: 'CaO (quicklite) is basic oxide', compoundsInfo: [{ formula: 'CaC₂O₄', color: 'White', hexColor: '#FFFFFF', nature: 'neutral' }], row: 4, col: 2 },
    ...
    { atomicNumber: 33, symbol: 'As', name: 'Arsenic', atomicMass: 74.92, category: 'Metalloid', block: 'p', group: 15, period: 4, electronConfig: '[Ar]3d¹⁰4s²4p³', atomicRadius: 121, ionicRadius: 222, ionizationEnergy: 947, electronegativity: 2.0, density: 5.778, meltingPoint: 1089, boilingPoint: 888, compoundsInfo: [{ formula: 'As₂S₃', color: 'Yellow (ppt)', hexColor: '#FFFF00', nature: 'acidic' }, { formula: '(NH₄)₃[As(Mo₃O₁₀)₄]', color: 'Canary Yellow', hexColor: '#FFEF00', nature: 'acidic' }], row: 4, col: 15 },
    ...
    { atomicNumber: 50, symbol: 'Sn', name: 'Tin', atomicMass: 118.71, category: 'Post-Transition Metal', block: 'p', group: 14, period: 5, electronConfig: '[Kr]4d¹⁰5s²5p²', atomicRadius: 140, ionicRadius: 118, ionizationEnergy: 708, electronegativity: 1.8, density: 7.26, meltingPoint: 505, boilingPoint: 2896, oxides: ['SnO', 'SnO₂'], oxideNature: 'amphoteric', oxideNatureDetails: 'SnO and SnO₂ are amphoteric oxides', compoundsInfo: [{ formula: 'SnS₂', color: 'Yellow (ppt)', hexColor: '#FFFF00', nature: 'amphoteric' }], row: 5, col: 14 },
    ...
    { atomicNumber: 55, symbol: 'Cs', name: 'Caesium', atomicMass: 132.91, category: 'Alkali Metal', block: 's', group: 1, period: 6, electronConfig: '[Xe]6s¹', atomicRadius: 265, ionicRadius: 167, ionizationEnergy: 376, electronegativity: 0.79, electronAffinity: -46, density: 1.90, meltingPoint: 302, boilingPoint: 944, standardReductionPotential: -2.927, flameColor: { color: 'Light blue', hexColor: '#87CEEB' }, oxides: ['Cs₂O'], oxideNature: 'basic', row: 6, col: 1 },
    { atomicNumber: 56, symbol: 'Ba', name: 'Barium', atomicMass: 137.33, category: 'Alkaline Earth Metal', block: 's', group: 2, period: 6, electronConfig: '[Xe]6s²', atomicRadius: 222, ionicRadius: 135, ionizationEnergy: 503, electronegativity: 0.89, density: 3.59, meltingPoint: 1002, boilingPoint: 2078, standardReductionPotential: -2.92, flameColor: { color: 'Green/yellow', hexColor: '#ADFF2F' }, oxides: ['BaO'], oxideNature: 'basic', compoundsInfo: [{ formula: 'BaCrO₄', color: 'Yellow (ppt)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'BaSO₃', color: 'White', hexColor: '#FFFFFF', nature: 'neutral' }, { formula: 'BaSO₄', color: 'White', hexColor: '#FFFFFF', nature: 'neutral' }], row: 6, col: 2 },
    ...
    { atomicNumber: 82, symbol: 'Pb', name: 'Lead', atomicMass: 207.2, category: 'Post-Transition Metal', block: 'p', group: 14, period: 6, electronConfig: '[Xe]4f¹⁴5d¹⁰6s²6p²', atomicRadius: 146, ionicRadius: 119, ionizationEnergy: 715, electronegativity: 1.9, density: 11.34, meltingPoint: 600, boilingPoint: 2024, flameColor: { color: 'Grey/white', hexColor: '#D3D3D3' }, oxides: ['PbO', 'PbO₂', 'Pb₃O₄'], oxideNature: 'amphoteric', oxideNatureDetails: 'PbO is amphoteric oxide', compoundsInfo: [{ formula: 'PbCrO₄', color: 'Yellow (ppt)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'PbI₂', color: 'Yellow (ppt)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'PbS', color: 'Black', hexColor: '#1A1A1A', nature: 'neutral' }, { formula: 'PbSO₄', color: 'White', hexColor: '#FFFFFF', nature: 'neutral' }], isException: true, exceptionType: 'Inert Pair Effect', exceptionExplanation: 'Pb shows +2 state more stable than +4 due to inert pair effect', row: 6, col: 14 },
    ...
    { atomicNumber: 85, symbol: 'At', name: 'Astatine', atomicMass: 210, category: 'Reactive Nonmetal', block: 'p', group: 17, period: 6, electronConfig: '[Xe]4f¹⁴5d¹⁰6s²6p⁵', atomicRadius: 127, ionizationEnergy: 920, electronegativity: 2.2, electronAffinity: -270, density: 7.00, meltingPoint: 575, boilingPoint: 610, row: 6, col: 17 },
    ...
    { atomicNumber: 47, symbol: 'Ag', name: 'Silver', atomicMass: 107.87, category: 'Transition Metal', block: 'd', group: 11, period: 5, electronConfig: '[Kr]4d¹⁰5s¹', atomicRadius: 165, ionizationEnergy: 731, electronegativity: 1.93, density: 10.49, meltingPoint: 1235, boilingPoint: 2435, standardReductionPotential: 0.80, compoundsInfo: [{ formula: 'AgI', color: 'Yellow (ppt)', hexColor: '#FFFF00', nature: 'neutral' }, { formula: 'Ag₂S', color: 'Black', hexColor: '#1A1A1A', nature: 'neutral' }, { formula: 'AgCl', color: 'White', hexColor: '#FFFFFF', nature: 'neutral' }], isException: true, exceptionType: 'Electron Configuration', exceptionExplanation: 'Ag has 4d¹⁰5s¹ (like Cu) for fully-filled d-orbital stability', row: 5, col: 11 },
