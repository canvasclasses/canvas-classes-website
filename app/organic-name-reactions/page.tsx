...
import { fetchOrganicReactions, OrganicReaction, getReactionStats, getUniqueReactionTypes } from '../lib/organicReactionsData';
...
export default function OrganicNameReactionsPage() {
    const [reactions, setReactions] = useState<OrganicReaction[]>([]);
    ...
    useEffect(() => {
        const loadData = async () => {
            const data = await fetchOrganicReactions();
            setReactions(data);
            setLoading(false);
        };
        loadData();
