...
interface RevisionClientProps {
    initialChapters: RevisionChapter[];
}

// Data is now fetched on the server and passed as props for SEO
export default function RevisionClient({ initialChapters }: RevisionClientProps) {
    const [chapters] = useState<RevisionChapter[]>(initialChapters);
