...
import { RevisionChapter, RevisionTopic, FlashcardItem } from '../../lib/revisionData';
import { ArrowLeft, BookOpen, Image as ImageIcon, Layers, Zap, CheckCircle, X, ChevronLeft, ChevronRight, RotateCcw, CheckCircle2, ZoomIn } from 'lucide-react';
...
interface ChapterClientProps {
    chapterData: RevisionChapter;
    infographicsTopics: RevisionTopic[];
    flashcards: FlashcardItem[];
    flashcardTopics: string[];
}

export default function ChapterClient({ chapterData, infographicsTopics, flashcards, flashcardTopics }: ChapterClientProps) {
