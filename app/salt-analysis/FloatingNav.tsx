...
export default function FloatingNav() {
    ...
    return (
        <>
            ...
            <div className="fixed right-3 top-[40%] -translate-y-1/2 z-50 md:hidden">
                <motion.button
                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            className="absolute right-0 top-12 bg-gray-900/95 backdrop-blur-xl border border-gray-700 rounded-xl shadow-2xl p-2 min-w-[140px]"
                        >
