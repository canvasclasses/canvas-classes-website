'use strict';
/**
 * Update the stored generation_prompt on Ch8 ("Journey Inside the Atom") image
 * blocks to the approved hand-drawn-dark style (from _ch8_newstyle.json), so the
...
const NEW = require('./_ch8_newstyle.json');
