...
const dir = __dirname;
const STAGE = '/private/tmp/claude-501/-Users-CanvasClasses-Desktop-canvas/522c0945-fbc7-427e-945c-cb0260d3c6fe/scratchpad/ieq_b3';
const BOOK = 'be7b5b7f-e993-4d3b-b9c8-52f7c308ab0e';
const CH = '7';
const map = JSON.parse(fs.readFileSync(path.join(dir, '_ieq_b3_map.json'), 'utf8'));
let ok = 0, fail = 0;
for (const m of map) {
...
console.log(`\n=== batch 3 ingest done: ${ok} ok, ${fail} failed ===`);
