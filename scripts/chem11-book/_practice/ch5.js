        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              prompt: 'ΔU° of combustion of methane is – X $\\text{kJ mol}^{-1}$. The value of ΔH° is\n(i) = ΔU° (ii) > ΔU° (iii) < ΔU° (iv) = 0',
              options: ['= ΔU°', '> ΔU°', '< ΔU°', '= 0'],
              correct_index: 2,
              explanation:
            ...
            },
            {
              ...
              prompt:
                'The reaction of cyanamide, $\\ce{NH2CN(s)}$, with dioxygen was carried out in a bomb calorimeter, and ΔU was found to be $-742.7\\ \\text{kJ mol}^{-1}$ at 298 K. Calculate enthalpy change for the reaction at 298 K.\n$\\ce{NH2CN(g) + 3/2 O2(g) -> N2(g) + CO2(g) + H2O(l)}$',
            ...
            },
            {
              ...
              prompt:
                'Calculate the enthalpy change on freezing of 1.0 mol of water at10.0°C to ice at –10.0°C. ΔfusH = $6.03\\ \\text{kJ mol}^{-1}$ at 0°C.\nCp[$\\ce{H2O(l)}$] = $75.3\\ \\text{J mol}^{-1}\\text{K}^{-1}$\nCp[$\\ce{H2O(s)}$] = $36.8\\ \\text{J mol}^{-1}\\text{K}^{-1}$',
          ...
          items: [
            {
              ...
              prompt:
                'The enthalpy of combustion of methane, graphite and dihydrogen at 298 K are, $-890.3\\ \\text{kJ mol}^{-1}$ $-393.5\\ \\text{kJ mol}^{-1}$, and $-285.8\\ \\text{kJ mol}^{-1}$ respectively. Enthalpy of formation of $\\ce{CH4(g)}$ will be\n(i) $-74.8\\ \\text{kJ mol}^{-1}$ (ii) $-52.27\\ \\text{kJ mol}^{-1}$ (iii) $+74.8\\ \\text{kJ mol}^{-1}$ (iv) $+52.26\\ \\text{kJ mol}^{-1}$.',
              options: ['$-74.8\\ \\text{kJ mol}^{-1}$', '$-52.27\\ \\text{kJ mol}^{-1}$', '$+74.8\\ \\text{kJ mol}^{-1}$', '$+52.26\\ \\text{kJ mol}^{-1}$'],
              correct_index: 0,
              explanation:
            ...
            },
            {
              ...
              prompt:
                'Enthalpy of combustion of carbon to $\\ce{CO2}$ is $-393.5\\ \\text{kJ mol}^{-1}$. Calculate the heat released upon formation of 35.2 g of $\\ce{CO2}$ from carbon and dioxygen gas.',
            ...
            },
            {
              ...
              prompt:
                'Enthalpies of formation of $\\ce{CO(g)}$, $\\ce{CO2(g)}$, $\\ce{N2O(g)}$ and $\\ce{N2O4(g)}$ are –110, –393, 81 and 9.7 $\\text{kJ mol}^{-1}$ respectively. Find the value of ΔrH for the reaction:\n$\\ce{N2O4(g) + 3CO(g) -> N2O(g) + 3CO2(g)}$',
              answer: 'ΔrH ≈ −777.7 kJ',
              solution:
            ...
            },
            {
              ...
              prompt:
                'Given\n$\\ce{N2(g) + 3H2(g) -> 2NH3(g)}$; ΔrH° = $-92.4\\ \\text{kJ mol}^{-1}$\nWhat is the standard enthalpy of formation of $\\ce{NH3}$ gas?',
              answer: 'ΔfH°[$\\ce{NH3}$] = −46.2 kJ/mol',
              solution:
            ...
            },
            {
              ...
              prompt:
                'Calculate the standard enthalpy of formation of $\\ce{CH3OH(l)}$ from the following data:\n$\\ce{CH3OH(l) + 3/2 O2(g) -> CO2(g) + 2H2O(l)}$; ΔrH° = $-726\\ \\text{kJ mol}^{-1}$\n$\\ce{C(graphite) + O2(g) -> CO2(g)}$; ΔcH° = $-393\\ \\text{kJ mol}^{-1}$\n$\\ce{H2(g) + 1/2 O2(g) -> H2O(l)}$; ΔfH° = $-286\\ \\text{kJ mol}^{-1}$.',
              answer: 'ΔfH°[$\\ce{CH3OH(l)}$] = −239 kJ/mol',
              solution:
            ...
            },
            {
              ...
              prompt:
                'Calculate the enthalpy change for the process\n$\\ce{CCl4(g) -> C(g) + 4 Cl(g)}$\nand calculate bond enthalpy of C–Cl in $\\ce{CCl4(g)}$.\nΔvapH°($\\ce{CCl4}$) = $30.5\\ \\text{kJ mol}^{-1}$.\nΔfH°($\\ce{CCl4}$) = $-135.5\\ \\text{kJ mol}^{-1}$.\nΔaH°(C) = $715.0\\ \\text{kJ mol}^{-1}$, where ΔaH° is enthalpy of atomisation\nΔaH°($\\ce{Cl2}$) = $242\\ \\text{kJ mol}^{-1}$',
            ...
            },
            {
              ...
              prompt:
                'Comment on the thermodynamic stability of NO(g), given\n$\\ce{1/2 N2(g) + 1/2 O2(g) -> NO(g)}$; ΔrH° = $90\\ \\text{kJ mol}^{-1}$\n$\\ce{NO(g) + 1/2 O2(g) -> NO2(g)}$: ΔrH° = $-74\\ \\text{kJ mol}^{-1}$',
              answer: 'NO is thermodynamically unstable relative to $\\ce{N2}$ + $\\ce{O2}$, and reacts further to the more stable $\\ce{NO2}$.',
              solution:
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              prompt: 'For the reaction,\n$\\ce{2 Cl(g) -> Cl2(g)}$, what are the signs of ΔH and ΔS?',
            ...
            },
            {
              ...
              prompt: 'The equilibrium constant for a reaction is 10. What will be the value of ΔG°? R = $8.314\\ \\text{JK}^{-1}\\text{mol}^{-1}$, T = 300 K.',
            ...
            },
            {
              ...
              prompt:
                'Calculate the entropy change in surroundings when 1.00 mol of $\\ce{H2O(l)}$ is formed under standard conditions. ΔfH° = $-286\\ \\text{kJ mol}^{-1}$.',
