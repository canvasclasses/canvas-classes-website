          ...
          items: [
            {
              ...
              answer:
                "Fusing the organic compound with sodium metal converts covalently-bound N, S, halogens into ionic NaCN, $\\ce{Na2S}$, NaX, which are then tested for as free ions in the sodium extract.",
              solution:
            ...
            },
            {
              ...
              answer:
                'Because the extract also contains NaCN and $\\ce{Na2S}$, which would themselves give precipitates with $\\ce{AgNO3}$ and give a false-positive test — $\\ce{HNO3}$ destroys them first.',
              solution:
            ...
            },
            {
              ...
              answer:
                'N, S and halogens are covalently bonded in the compound and give no ionic test as such — fusion with sodium converts them to ionic sodium salts (NaCN, $\\ce{Na2S}$, NaX) that are water-soluble and testable.',
              solution:
            ...
            },
            {
              ...
              prompt: 'Will $\\ce{CCl4}$ give white precipitate of AgCl on heating it with silver nitrate? Give reason for your answer.',
              answer: 'No — $\\ce{CCl4}$ has no ionisable chlorine; the C–Cl bonds are covalent and are not broken by simply heating with $\\ce{AgNO3}$.',
              solution:
            ...
            },
            {
              ...
              answer:
                'Because $\\ce{H2SO4}$ would form insoluble white $\\ce{PbSO4}$ with the lead acetate reagent, masking or being confused with the actual black PbS test for sulphur.',
              solution:
          ...
          items: [
            {
              ...
              answer:
                "Dumas: the compound's nitrogen is converted to $\\ce{N2}$ gas by combustion with CuO, and its volume is measured directly. Kjeldahl: the compound's nitrogen is converted to $\\ce{NH3}$ by heating with $\\ce{H2SO4}$, and the ammonia is estimated by titration.",
              solution:
            ...
            },
            {
              ...
              answer: 'KOH is a strong base that absorbs acidic $\\ce{CO2}$ completely and quantitatively as $\\ce{K2CO3}$, so all the $\\ce{CO2}$ formed is captured and its mass gives a reliable measure of the carbon content.',
              solution:
          ...
          items: [
            {
              ...
              answer:
                "Carius method: heat the compound with fuming $\\ce{HNO3}$ and $\\ce{AgNO3}$ (for halogens) or with a bromine/oxidising mixture (for S and P) inside a sealed tube, then weigh the precipitate formed (AgX, $\\ce{BaSO4}$, or $\\ce{Mg2P2O7}$) to back-calculate the element's mass.",
              solution:
