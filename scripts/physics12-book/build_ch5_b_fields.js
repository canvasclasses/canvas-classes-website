...
const p7 = {
  ...
  glossary: [
    { term: 'Fleming\'s left-hand rule', definition: 'A mnemonic for the force on a current in a field: forefinger along B, middle finger along I, thumb gives the force.' },
  ],
  blocks: [
