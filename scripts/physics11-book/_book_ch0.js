'use strict';
/**
 * Shared scaffold for the Class 11 Physics Live Book — Chapter 0.
 ...
 *
 * Book: "Class 11 Physics" (subject: physics, grade 11, board ncert)
 * Chapter 0: "Mathematics in Physics" — the prerequisite toolbox chapter that
 * every coaching programme teaches before NCERT Ch.1. chapter_number 0 so it
 * always sorts ahead of Units and Measurement.
 *
 * Plan: _agents/plans/PHYSICS_CH0_MATHS_FOR_PHYSICS_PLAN.md
 */
const { computeReadingTime, computeContentTypes, withDb } = require('../lib/book-writer');
const { v4: uuidv4 } = require('uuid');

const BOOK = {
  slug: 'class11-physics',
...
const CH = {
  ...
  slug: 'mathematics-in-physics',
  description:
    'The toolbox before the workshop. Scientific notation, rearranging formulas, trigonometry, ' +
    'graphs and slopes — and then vectors in depth: adding them tip-to-tail, the parallelogram law, ' +
    'subtracting them, and resolving them into components, all with interactive boards you can drag.',
};
...
// vector-spec factory: v('A', 6, 0, { color:'indigo', draggable:true })
...
module.exports = { BOOK, CH, b, q, v, ensureBookAndChapter, insertPages, withDb };
