'use strict';
/**
 * Place additional audited physics sims onto Ch6 pages, just before the closing quiz.
 * Idempotent: skips any page that already has the target sim.
 *
 *   node scripts/science-ch6/place_more_sims.js [--dry]
 */
...
// Update this list as new sims are audited and approved.
const PLACEMENTS = [
  { slug: 'forces-on-a-system', sim: 'force-balance', title: 'Force Balance Lab' },
];
