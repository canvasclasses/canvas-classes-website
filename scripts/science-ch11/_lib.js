'use strict';
/**
 * Shared toolkit for building Class 9 Science Ch.11 (Reproduction) pages.
 * Block factories match packages/data/books/schemas.ts exactly. Pages are
 * updated IN PLACE by slug (the 16 stub pages already exist + are published).
 */
...
/**
 * applyPages([{ slug, subtitle, blocks }]) — updates each page in place.
 * Pass --dry on argv to print the plan without writing.
 */
...
module.exports = { img, txt, h, h3, cur, callout, cmp, table, reason, worked, q, quiz, applyPages, uid, seq };
