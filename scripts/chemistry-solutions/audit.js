#!/usr/bin/env node
// audit.js — end-of-chapter heuristic sweep over every solution in a chemistry chapter.
//
// Usage:
//   node scripts/chemistry-solutions/audit.js <PREFIX> [--missing-only] [--sample=N]
//
// Mirror of scripts/physics-solutions/audit.js. Read-only against MongoDB; only writes
// to <PREFIX>-flags.md.
