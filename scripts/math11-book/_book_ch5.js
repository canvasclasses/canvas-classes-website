 ...
 * Chapter 5: "Linear Inequalities" (NCERT Ch.5 numbering kept, so other chapters
 * can be added later at their own numbers).
 */
...
const CH = {
  ...
  description:
    'Solving linear inequalities in one variable and the sign-flip rule; graphing a linear ' +
    'inequality in two variables as a shaded half-plane; and systems of two or three ' +
    'inequalities as the overlap of shaded regions — taught through interactive shaded graphs.',
};
