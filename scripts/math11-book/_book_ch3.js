'use strict';
/**
 * Shared scaffold for Class 11 Mathematics — Chapter 3 "Trigonometric Functions".
 * Mirrors _book.js (Ch.2) exactly in structure. PURELY ADDITIVE + idempotent
 * (matches by slug). Everything is created UNPUBLISHED — nothing reaches
 * students until the founder reviews + publishes in the admin books editor.
 * DO NOT edit _book.js — this is a separate, parallel scaffold for Ch.3 so
...
const CH = {
  ...
  description:
    'Angles in degree and radian measure; the unit-circle definition of sine and cosine and the four ' +
    'other ratios; domain, range, signs and graphs of all six functions; the sum-and-difference, ' +
    'multiple-angle and sum-to-product identities; and solving trigonometric equations — anchored by a ' +
    'dynamic, draggable unit circle throughout.',
};
