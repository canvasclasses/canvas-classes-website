...
import AnalyticsDashboard from '@/features/crucible/components/admin/AnalyticsDashboard';
import ExportDashboard from '@/features/crucible/components/admin/ExportDashboard';
...
import BulkImportModal from '@/features/crucible/components/admin/BulkImportModal';
import MathRenderer from '@canvas/ui/MathRenderer';
import AudioRecorder from '@/features/crucible/components/admin/AudioRecorder';
import AudioPlayer from '@/features/crucible/components/admin/AudioPlayer';
import SVGScaleControls from '@/features/crucible/components/admin/SVGScaleControls';
import SVGDropZone from '@/features/crucible/components/admin/SVGDropZone';
import VideoDropZone from '@/features/crucible/components/admin/VideoDropZone';
import RoleManagement from '@/features/crucible/components/admin/RoleManagement';
import MockTestsAdmin from '@/features/crucible/components/admin/MockTestsAdmin';
import FlagsDashboard from '@/features/crucible/components/admin/FlagsDashboard';
import FlagModal, { type FlagSubmission } from '@/features/crucible/components/admin/FlagModal';
import AdminSectionTabs, { type AdminSection } from '@/features/crucible/components/admin/AdminSectionTabs';
import AdminFilterRow from '@/features/crucible/components/admin/AdminFilterRow';
import AITagSuggestionsBox from '@/features/crucible/components/admin/AITagSuggestionsBox';
import QuestionPreviewPane from '@/features/crucible/components/admin/QuestionPreviewPane';
import QuestionTaggingRow from '@/features/crucible/components/admin/QuestionTaggingRow';
import { usePermissions } from '@/features/crucible/hooks/admin/usePermissions';
import { useAdminKeyNav } from '@/features/crucible/hooks/admin/useAdminKeyNav';
import { useAdminFilterUrlSync } from '@/features/crucible/hooks/admin/useAdminFilterUrlSync';
import { type AdminQuestion as Question, type AdminChapter as Chapter, QUESTION_TYPES } from '@/features/crucible/components/admin/types';
