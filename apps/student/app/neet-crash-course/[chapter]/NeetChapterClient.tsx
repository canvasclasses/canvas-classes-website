...
import { NeetChapter, NeetLecture } from '@/features/public-content/data/neetCrashCourseData';

export default function NeetChapterClient({ chapter }: { chapter: NeetChapter }) {
    // Tab State
