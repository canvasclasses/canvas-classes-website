...
function BannerInner() {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between gap-3 px-4 sm:px-6 pt-[38px] pb-2.5 rounded-full bg-gradient-to-r from-orange-500/[0.12] via-amber-500/[0.08] to-amber-400/[0.04] backdrop-blur-xl border border-t-0 border-orange-500/25 shadow-md shadow-amber-950/30">
                {/* Lead label */}
