...
// StructureEditorClient over the canvas; this is just the control panel:
// load/paste, opacity, SIZE (so a big pasted image can be shrunk to draw over),
// a move/resize toggle (drag to reposition without drawing), show/hide, clear.
