 ...
 *   - no suffix → width: 100%
 *
 * TODO (Phase 5.6): the student app has a near-identical copy at
 * apps/student/features/flashcards/lib/flashcardMarkdown.tsx. Promote to a
 * shared package (@canvas/ui or new @canvas/flashcards) and have both apps
 * import from there. Keep this file byte-for-byte equal to the student copy
 * until then — any divergence is a bug.
 */
