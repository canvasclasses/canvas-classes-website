...
import {
    Search, X, BookOpen, Clock, Sparkles, ChevronLeft, ChevronRight, Plus, ArrowRight,
            ...
            <header className="border-b border-white/5 bg-[#050505]/80 backdrop-blur sticky top-0 z-20">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link
                            href="/"
                            className="hidden lg:inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-sm"
                        >
                            <ChevronLeft size={14} />
                            Home
                        </Link>
